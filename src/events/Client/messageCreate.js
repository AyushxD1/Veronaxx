...
const owner = ["768011480993497118"]
  ...
  if (message.content.match(mention)) {
    const lawde = new MessageActionRow()
       ...
       new MessageButton()
        .setLabel("Support")
        .setStyle("LINK")
        .setURL("https://discord.gg/EhYwpUDHUE"),
       new MessageButton()
        .setLabel("Vote")   
        .setStyle("LINK")  
        .setURL(`https://discord.gg/EhYwpUDHUE`), 
      ...
      const embed = new MessageEmbed()
        ...
        .setFooter(`Made with Horrny Fellings`, message.guild.iconURL({dynamic: true}))
 .setThumbnail("https://cdn.discordapp.com/avatars/1200537054585553068/dbb7047ab8dfd0d32cff453fc79999eb.webp?size=4096")
                      
        .setDescription(`**My prefix here is \`${prefix}\`\nVoice Region: \`${m}\`\nServer Id: \`${message.guild.id}\`\n\nType ${prefix}help to see all commands of Verona Prime**`, {
            Pre: prefix
